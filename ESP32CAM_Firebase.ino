...
String FIREBASE_HOST = "smartbrankas-azfi-default-rtdb.firebaseio.com";
String FIREBASE_AUTH = "S0mRAprfgmcl8jPDFmw39WgGcXHf4vDSVVLhiMkm";
...
#define FIREBASE_HOST "https://smartbrankas-azfi-default-rtdb.asia-southeast1.firebasedatabase.app/"
#define FIREBASE_AUTH "AIzaSyA81HxQWu5zIKBS4DrEuJzQpTsNrp3LqHk"
...
void Photo2Base64() {
    ...
    json.set("/stream_dataface", imageFile);
    Firebase.updateNode(firebaseData,"/ESP32",json);
    Serial.println("send data");
    Serial.println("FILE DATA"+imageFile);
    //delay(500);
    //return imageFile;
}
...
void loop() { 
  /*json.set("/stream_face", Photo2Base64());
  Firebase.updateNode(firebaseData,"/ESP32",json);
  Serial.println("send data");
  delay(500);*/
  Photo2Base64();
